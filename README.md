...
<img src=‘movie2.gif’ title='Video Walkthrough' width='' alt='Video Walkthrough' />
...
Had a lot of trouble loading page 0 into the view pager, kept loading page 1 twice? I literally have no clue. My code looks right, it would just kind of do its own thing, if anyone can tell me why it is behaving that way I would be very grateful. Same with null reference exceptions while tapping individual tweets, going to keep working on that tonight.
...
**Twit** is an android app that allows a user to view his Twitter timeline and post a new tweet. The app utilizes [Twitter REST API](https://dev.twitter.com/rest/public).
